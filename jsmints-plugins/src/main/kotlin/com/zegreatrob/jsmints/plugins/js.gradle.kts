...
dependencies {
    ...
    "commonMainImplementation"(platform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.339"))
    "commonMainImplementation"(platform("com.zegreatrob.testmints:testmints-bom:7.4.8"))
}
