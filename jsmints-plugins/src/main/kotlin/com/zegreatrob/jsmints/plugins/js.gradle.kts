...
dependencies {
    ...
    "commonMainImplementation"(platform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.358"))
    "commonMainImplementation"(platform("com.zegreatrob.testmints:testmints-bom:8.1.1"))
}
