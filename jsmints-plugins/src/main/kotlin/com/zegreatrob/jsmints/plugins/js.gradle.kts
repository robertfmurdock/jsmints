...
dependencies {
    ...
    "commonMainImplementation"(platform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.345"))
    "commonMainImplementation"(platform("com.zegreatrob.testmints:testmints-bom:8.0.0"))
}
